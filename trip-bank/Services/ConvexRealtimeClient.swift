...
// MARK: - Convex Realtime Client

/// Wrapper around the official ConvexMobile SDK that provides both:
/// 1. Real-time subscriptions via WebSocket
/// 2. Backward compatibility with existing HTTP-based mutation methods
@MainActor
class ConvexRealtimeClient {
    static let shared = ConvexRealtimeClient()
    ...
    func ensureLoggedIn() async {
        do {
            ...
            print("✅ [ConvexRealtime] Authenticated from cache")
        } catch {
            print("⚠️ [ConvexRealtime] Cache login failed, trying full login")
            do {
                let _ = try await convexClient.login()
                print("✅ [ConvexRealtime] Authenticated successfully")
            } catch {
                print("❌ [ConvexRealtime] Authentication failed: \(error)")
            }
        }
    }
    ...
    func createTrip(
        ...
        return try await mutation("trips:createTrip", args: args)
    }
    ...
    func updateTrip(
        ...
        return try await mutation("trips:updateTrip", args: args)
    }

    func deleteTrip(id: String) async throws -> DeleteResponse {
        return try await mutation("trips:deleteTrip", args: ["tripId": id])
    }
    ...
    func addMediaItem(
        ...
        return try await mutation("trips:addMediaItem", args: args)
    }
    ...
    func updateMediaItem(
        ...
        return try await mutation("trips:updateMediaItem", args: args)
    }

    func deleteMediaItem(id: String) async throws -> DeleteResponse {
        return try await mutation("trips:deleteMediaItem", args: ["mediaItemId": id])
    }
    ...
    func addMoment(
        ...
        return try await mutation("trips:addMoment", args: args)
    }
    ...
    func updateMoment(
        ...
        return try await mutation("trips:updateMoment", args: args)
    }

    func deleteMoment(id: String) async throws -> DeleteResponse {
        return try await mutation("trips:deleteMoment", args: ["momentId": id])
    }
    ...
    func updateMomentGridPosition(id: String, gridPosition: GridPosition) async throws -> DeleteResponse {
        ...
        return try await mutation("trips:updateMomentGridPosition", args: args)
    }
    ...
    func batchUpdateMomentGridPositions(updates: [(String, GridPosition)]) async throws -> DeleteResponse {
        ...
        return try await mutation("trips:batchUpdateMomentGridPositions", args: args)
    }

    // MARK: - Sharing & Permissions

    func generateShareLink(tripId: String) async throws -> ShareLinkResponse {
        return try await mutation("trips:generateShareLink", args: ["tripId": tripId])
    }

    func disableShareLink(tripId: String) async throws -> DeleteResponse {
        return try await mutation("trips:disableShareLink", args: ["tripId": tripId])
    }
    ...
    func joinTripViaLink(shareSlug: String?, shareCode: String?) async throws -> JoinTripResponse {
        ...
        return try await mutation("trips:joinTripViaLink", args: args)
    }
    ...
    func updatePermission(tripId: String, userId: String, newRole: String) async throws -> DeleteResponse {
        ...
        return try await mutation("trips:updatePermission", args: args)
    }
    ...
    func removeAccess(tripId: String, userId: String) async throws -> DeleteResponse {
        ...
        return try await mutation("trips:removeAccess", args: args)
    }
